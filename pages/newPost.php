...
if ($user != null) {
    ...
    echo '<span class="formHead">Název:</span> <input class="postLine" type="text" name="Název"><br>';
    echo '<span class="formHead">Obsah:</span> <input class="postContent" type="text" name="Obsah"><br>';
